...
$catalogue = new MessageCatalogue('ru', array (
  ...
  'messages' => 
  array (
    'sg.datatables.confirmMessage' => 'Вы уверены?',
    'sg.datatables.selectError' => 'Вы должны выбрать хотя бы один элемент',
    'sg.datatables.actions.title' => 'Действия',
    'sg.datatables.actions.show' => 'Показать',
    'sg.datatables.actions.edit' => 'Редактировать',
    'sg.datatables.daterange.apply' => 'Применить',
    'sg.datatables.daterange.cancel' => 'Отменить',
