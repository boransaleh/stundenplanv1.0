...
/* @SgDatatables/datatable/events.html.twig */
class __TwigTemplate_eab16db0d3397e6e654c9626976d43dc6433e1256b5b19f561136b6ba67a4e96 extends Twig_Template
{
    ...
    {
        $__internal_630135aa0877f99b83a1fd140a6f4801935e203e58091ed0ee4a1bea22e3cde2 = $this->env->getExtension("Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension");
        $__internal_630135aa0877f99b83a1fd140a6f4801935e203e58091ed0ee4a1bea22e3cde2->enter($__internal_630135aa0877f99b83a1fd140a6f4801935e203e58091ed0ee4a1bea22e3cde2_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@SgDatatables/datatable/events.html.twig"));

        $__internal_705110ff3874b33009f774125e54c51b8146aeee51d59c7dca798f39d0e56ecd = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_705110ff3874b33009f774125e54c51b8146aeee51d59c7dca798f39d0e56ecd->enter($__internal_705110ff3874b33009f774125e54c51b8146aeee51d59c7dca798f39d0e56ecd_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@SgDatatables/datatable/events.html.twig"));
...
";
        ...
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "columnVisibility", array()) === null)) {
            ...
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "columnVisibility", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 23)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 25
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "destroy", array()) === null)) {
            ...
            // line 31
            echo "    .on('destroy.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "destroy", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 31)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 33
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "error", array()) === null)) {
            ...
            // line 39
            echo "    .on('error.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "error", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 39)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 41
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "length", array()) === null)) {
            ...
            // line 47
            echo "    .on('length.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "length", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 47)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 49
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "order", array()) === null)) {
            ...
            // line 55
            echo "    .on('order.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "order", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 55)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 57
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "page", array()) === null)) {
            ...
            // line 63
            echo "    .on('page.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "page", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 63)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 65
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "preInit", array()) === null)) {
            ...
            // line 71
            echo "    .on('preInit.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "preInit", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 71)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 73
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "preXhr", array()) === null)) {
            ...
            // line 79
            echo "    .on('preXhr.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "preXhr", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 79)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 81
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "processing", array()) === null)) {
            ...
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "processing", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 87)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 89
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "search", array()) === null)) {
            ...
            // line 95
            echo "    .on('search.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "search", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 95)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 97
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "stateLoaded", array()) === null)) {
            ...
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "stateLoaded", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 103)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 105
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "stateLoadParams", array()) === null)) {
            ...
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "stateLoadParams", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 111)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 113
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "stateSaveParams", array()) === null)) {
            ...
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "stateSaveParams", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 119)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        // line 121
        if ( !($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "xhr", array()) === null)) {
            ...
            // line 127
            echo "    .on('xhr.dt', ";
            $this->loadTemplate($this->getAttribute($this->getAttribute($this->getAttribute(($context["sg_datatables_view"] ?? $this->getContext($context, "sg_datatables_view")), "events", array()), "xhr", array()), "template", array(), "array"), "@SgDatatables/datatable/events.html.twig", 127)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ")
";
        }
        
        $__internal_630135aa0877f99b83a1fd140a6f4801935e203e58091ed0ee4a1bea22e3cde2->leave($__internal_630135aa0877f99b83a1fd140a6f4801935e203e58091ed0ee4a1bea22e3cde2_prof);

        
        $__internal_705110ff3874b33009f774125e54c51b8146aeee51d59c7dca798f39d0e56ecd->leave($__internal_705110ff3874b33009f774125e54c51b8146aeee51d59c7dca798f39d0e56ecd_prof);

    }

    public function getTemplateName()
    {
        return "@SgDatatables/datatable/events.html.twig";
    }
...
{% endif %}
", "@SgDatatables/datatable/events.html.twig", "C:\\Apache24\\htdocs\\vendor\\sg\\datatablesbundle\\Resources\\views\\datatable\\events.html.twig");
    }
}
