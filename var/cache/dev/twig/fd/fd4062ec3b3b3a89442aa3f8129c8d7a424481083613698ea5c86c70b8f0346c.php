...
/* @SgDatatables/datatable/button.html.twig */
class __TwigTemplate_4b53738463e45a3c2c44328b358b59645a243b799b4eda07ea7e5a6be9667722 extends Twig_Template
{
    ...
    {
        $__internal_e58f05698f9424a14add122e4fb7c8c1d0d52cd8eb98b48134fef078508f516e = $this->env->getExtension("Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension");
        $__internal_e58f05698f9424a14add122e4fb7c8c1d0d52cd8eb98b48134fef078508f516e->enter($__internal_e58f05698f9424a14add122e4fb7c8c1d0d52cd8eb98b48134fef078508f516e_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@SgDatatables/datatable/button.html.twig"));

        $__internal_457952a185e4990a741adcffb8565bae062ba94cfbb22b1d7be06339555206e3 = $this->env->getExtension("Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension");
        $__internal_457952a185e4990a741adcffb8565bae062ba94cfbb22b1d7be06339555206e3->enter($__internal_457952a185e4990a741adcffb8565bae062ba94cfbb22b1d7be06339555206e3_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "@SgDatatables/datatable/button.html.twig"));
    ...
    ";
        ...
        if (($this->getAttribute(($context["button"] ?? null), "action", array(), "any", true, true) &&  !($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "action", array()) === null))) {
            ...
            // line 8
            echo "        action: ";
            $this->loadTemplate($this->getAttribute($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "action", array()), "template", array(), "array"), "@SgDatatables/datatable/button.html.twig", 8)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ",
    ";
        }
        // line 10
        ...
        if (($this->getAttribute(($context["button"] ?? null), "available", array(), "any", true, true) &&  !($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "available", array()) === null))) {
            ...
            // line 16
            echo "        available: ";
            $this->loadTemplate($this->getAttribute($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "available", array()), "template", array(), "array"), "@SgDatatables/datatable/button.html.twig", 16)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ",
    ";
        }
        // line 18
    ...
    ";
        ...
        if (($this->getAttribute(($context["button"] ?? null), "destroy", array(), "any", true, true) &&  !($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "destroy", array()) === null))) {
            ...
            // line 27
            echo "        destroy: ";
            $this->loadTemplate($this->getAttribute($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "destroy", array()), "template", array(), "array"), "@SgDatatables/datatable/button.html.twig", 27)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ",
    ";
        }
        // line 29
    ...
    ";
        ...
        if (($this->getAttribute(($context["button"] ?? null), "init", array(), "any", true, true) &&  !($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "init", array()) === null))) {
            ...
            // line 41
            echo "        init: ";
            $this->loadTemplate($this->getAttribute($this->getAttribute(($context["button"] ?? $this->getContext($context, "button")), "init", array()), "template", array(), "array"), "@SgDatatables/datatable/button.html.twig", 41)->display(array_merge($context, ($context["vars"] ?? $this->getContext($context, "vars"))));
            echo ",
    ";
        }
        // line 43
...
";
        ...
        $__internal_e58f05698f9424a14add122e4fb7c8c1d0d52cd8eb98b48134fef078508f516e->leave($__internal_e58f05698f9424a14add122e4fb7c8c1d0d52cd8eb98b48134fef078508f516e_prof);

        
        $__internal_457952a185e4990a741adcffb8565bae062ba94cfbb22b1d7be06339555206e3->leave($__internal_457952a185e4990a741adcffb8565bae062ba94cfbb22b1d7be06339555206e3_prof);

    }

    public function getTemplateName()
    {
        return "@SgDatatables/datatable/button.html.twig";
    }
...
", "@SgDatatables/datatable/button.html.twig", "C:\\Apache24\\htdocs\\vendor\\sg\\datatablesbundle\\Resources\\views\\datatable\\button.html.twig");
    }
}
